...
<body class="home blog halimthemes halimmovies" data-masonry="">
                        ...
                        <div class="col-xs-12">
                            <style type="text/css">
                             ul#result{
                               ...
                               <ul class="list-group-item" id="result" style="display:none;">
    ...
    <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0" nonce="iGUptPWn"></script>
